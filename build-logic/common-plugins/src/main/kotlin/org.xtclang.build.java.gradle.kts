...
// TrikeShed ring series for VmPointcutPublisher (javatools must not transitively depend on it)
repositories.mavenLocal()
repositories.mavenCentral()
dependencies.add("implementation", "org.bereft:TrikeShed:1.0")
dependencies.add("testRuntimeOnly", "org.bereft:TrikeShed:1.0")
// Kotlin stdlib — RingSeries uses kotlin.jvm.functions.Function1 at runtime
dependencies.add("compileOnly", "org.jetbrains.kotlin:kotlin-stdlib-jdk8:2.4.0-Beta2")
