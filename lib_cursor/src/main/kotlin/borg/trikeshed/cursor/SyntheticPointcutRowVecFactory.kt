...
object Symbols {
    ...
    val TypeInfo = symbol("typeInfo")
    val ClassfileCoordinate = symbol("classfileCoordinate")
    val XvmCoordinate = symbol("xvmCoordinate")
    val PointcutKind = symbol("pointcutKind")
    val PoolId = symbol("poolId")
    val CodecHash = symbol("codecHash")
    val Wireproto = symbol("wireproto")
    val DomainId = symbol("domainId")
    val DomainName = symbol("domainName")
    val FacetId = symbol("facetId")
    val ColumnCount = symbol("columnCount")
    val Columns = symbol("columns")
    val Children = symbol("children")
    val Ordinal = symbol("ordinal")
    val Name = symbol("name")
    val Type = symbol("type")
    val Facet = symbol("facet")
    val CollectionName = symbol("collectionName")
    val Owner = symbol("owner")
    val KeyType = symbol("keyType")
    val ValueType = symbol("valueType")
    val Cardinality = symbol("cardinality")
    val LifecyclePhase = symbol("lifecyclePhase")
    val SourceMember = symbol("sourceMember")
    val SourceFile = symbol("sourceFile")
    val SourcePath = symbol("sourcePath")
    val PackagePattern = symbol("packagePattern")
    val StringType = symbol("String")
    val IntType = symbol("Int")
    val LongType = symbol("Long")
    val BytesType = symbol("Bytes")
    val ArrayType = symbol("Array")

    val MethodEntry = pointcutName("method-entry")
    val FieldRead = pointcutName("field-read")
    val FieldWrite = pointcutName("field-write")
...
private fun ColumnMetaRef.typeMemento(): TypeMemento = when (type) {
